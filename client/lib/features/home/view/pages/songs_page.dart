                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          Flexible(child: Text(song.song_name,style: const TextStyle(fontSize: 13,fontWeight: FontWeight.w700,overflow: TextOverflow.ellipsis ),maxLines: 1,))
                      ],
                    ),
                  ),
                );
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      SizedBox(
                        width: 180,
                        child: Text(
                          song.song_name,style: const TextStyle(
                        ...
                        width: 180,
                        child: Text(
                          song.artist,style: const TextStyle(
