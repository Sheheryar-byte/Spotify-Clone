        ...
        body: Column(children: [
          ...
          Expanded(
            ...
            child: Column(children: [
              Row(
                children: [
                  Column(
                    ...
                    children: [
                      Text(currentSong.song_name,style: const TextStyle(
                        color: Pallete.whiteColor,
                        fontSize: 24,
                        fontWeight: FontWeight.w700
                      ),),
            
                      Text(currentSong.artist,style: const TextStyle(
                        color: Pallete.whiteColor,
                        fontSize: 16,
              ...
              if (position != null && duration!= null){
                ...
                child: Slider(value: sliderValue, min: 0, max: 1, onChanged: (val) {sliderValue = val;}, onChangeEnd: songNotifier.seek,
                  
                )),
                
                 Row(children: [
                            Text('${position?.inMinutes}:${(position?.inSeconds ?? 0)  < 10 ? '0${position?.inSeconds}' : position?.inSeconds } ',style: const TextStyle(
                ...
                fontWeight: FontWeight.w300,
                           ...
                           const  Expanded(child: SizedBox(),),
                            ...
                            Text('${duration?.inMinutes}:${(duration?.inSeconds ?? 0)  < 10 ? '0${duration?.inSeconds}' : duration?.inSeconds }' ,style: const TextStyle(
                color: Pallete.subtitleText,
                fontSize: 13,
                fontWeight: FontWeight.w300,
                            ),
          ...
          Row(
            ...
            children: [
               ...
               Padding(
                 padding: const EdgeInsets.all(10.0),
                 child: Image.asset('assets/images/previus-song.png',color: Pallete.whiteColor,),
               ),
               IconButton(onPressed: songNotifier.playPause, icon:  Icon(songNotifier.isPlaying? CupertinoIcons.pause_circle_fill : CupertinoIcons.play_circle_fill),
               iconSize: 80,color: Pallete.whiteColor,),
