...
class HomeViewModel extends _$HomeViewModel{
  ...
  Future<void> uploadSong({
    ...
    final res = await _homeRepository.uploadSong(selectedAudio:selectedAudio,
  ...
  AsyncValue  _favSongSuccess(bool isFavorited, String songId){
    ...
    if (isFavorited){
      userNotifier.addUser(ref.read(currentUserNotifierProvider)!.copyWith(favorites: [
      ...
      userNotifier.addUser(ref.read(currentUserNotifierProvider)!.copyWith(favorites: ref.read(currentUserNotifierProvider)!.favorites.where((fav) => fav.song_id != songId,).toList()));
    }
